...
export const HOME_ROW_OPTIONS: { key: string; label: string }[] = [
  { key: "yts-trend", label: "Trending now" },
  { key: "yts-recent", label: "Recently added" },
  { key: "yts-top10", label: "Top 10" },
  { key: "yts-horror", label: "Horror" },
  { key: "yts-comedy", label: "Comedy" },
  { key: "yts-scifi", label: "Sci-Fi" },
  { key: "yts-action", label: "Action" },
